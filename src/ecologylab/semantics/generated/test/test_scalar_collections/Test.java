...
public class Test extends Metadata
{
	...
	/** 
	 */ 
	@simpl_collection @mm_name("coll1")	private List<MetadataParsedURL> coll1;

	/** 
	 */ 
	@simpl_collection @mm_name("coll2")	private List<MetadataString> coll2;

	/** 
	 */ 
	@simpl_collection @mm_name("coll3")	private List<MetadataInteger> coll3;

	/** 
	 */ 
	@simpl_collection @mm_name("coll4")	private List<MetadataInteger> coll4;

	/** 
	 */ 
	@simpl_collection("thing") @mm_name("coll5")	private List<MetadataInteger> coll5;

	/** 
	 */ 
	@simpl_collection @mm_name("coll6")	private List<MetadataFloat> coll6;
	...
	public MetadataParsedURL getAScalarMetadata()
	{
		return aScalar;
	}
	...
	public void setAScalarMetadata(MetadataParsedURL aScalar)
	{
