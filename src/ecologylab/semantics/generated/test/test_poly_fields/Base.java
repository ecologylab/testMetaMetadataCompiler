...
public class Base extends Metadata
{
	 ...
	 */ 
	@simpl_composite	@simpl_classes({MmdInlineMyItemInSub.class, Item.class, MmdInlineYourItemInSubSub.class}) @mm_name("first_item")	private Item firstItem;

	/** 
	 * the collection of items.
	 */ 
	@simpl_collection	@simpl_classes({MmdInlineMyItemInSub.class, Item.class, MmdInlineYourItemInSubSub.class}) @mm_name("items")	private List<Item> items;
